...
describe('GET /api/concerts', () => {
  before(async () => {
    const testConcertOne = new Concert({ 
        ...
        performer: 'Test Performer One', 
        genre: 'Test Genre One', 
        price: 40, 
        day: 1, 
        image: 'Test Image1' });
    ...
    const testConcertTwo = new Concert({ 
        _id: '62d9bf1d97a071e22e585639', 
        performer: 'Test Performer Two', 
        genre: 'Test Genre Two', 
        price: 100, 
        day: 2, 
        image: 'Test Image2' });
    ...
    const testConcertThree = new Concert({ 
        ...
        performer: 'Test Performer Three', 
        genre: 'Test Genre Three', 
        price: 150, 
        day: 3, 
        image: 'Test Image3' });
  ...
  it('it should return a concert by price', async () => {
    const res = await request(server).get('/api/concerts/price/40/150');
    expect(res.status).to.equal(200);
    expect(res.body).to.be.an('array');
